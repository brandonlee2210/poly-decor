				...
				<div>
						...
						<div className="flex items-center gap-5">
							{availableColors.map((color) => (
								<span
									...
									onClick={() =>
										handleVariantChange(color.id, null)
									}
								></span>
							))}
						</div>
					...
					{availableMaterials.length > 0 && (
						<div className="mt-5">
							...
							<select
								...
								value={material}
								onChange={(e) =>
									handleVariantChange(null, e.target.value)
								}
							>
					...
					<div className="grid grid-cols-2 gap-6 mt-10">
						<div className="bg-brown-light text-brown-strong flex items-center justify-center gap-1 py-4 rounded-lg text-xl font-bold duration-200 border-2 hover:bg-white hover:border-brown-strong hover:border-2">
							<i className="fa-regular fa-credit-card"></i> Mua
							ngay
						</div>
						<div
							onClick={addToCart}
						...
						>
							<i className="fa-solid fa-cart-plus"></i> Thêm vào
							giỏ hàng
						</div>
					</div>
				</div>
